...
public class ErrorWindow : Window
{
    ...
    {
        Title = $"{LocalizationService.Get("Error_WindowTitle")}{title}";
        Width = 640;
        Height = 400;
        MinWidth = 420;
        MinHeight = 250;
        ...
        {
            Content = LocalizationService.Get("Error_CopyDetails"),
        ...
        copyBtn.Click += (_, _) =>
        {
            ...
            copyBtn.Content = LocalizationService.Get("Error_Copied");
        };

        var closeBtn = new Button
        {
            Content = LocalizationService.Get("Error_Close"),
            Padding = new Thickness(16, 6, 16, 6),
