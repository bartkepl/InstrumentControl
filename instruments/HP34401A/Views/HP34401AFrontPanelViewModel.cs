...
public partial class HP34401AFrontPanelViewModel : ObservableObject
{
    private readonly HP34401ADriver _driver;
    ...
    {
        "DCV", "ACV", "DCI", "ACI", "RES2W", "RES4W", "FREQ", "PERIOD", "DIODE", "CONT"
    };
    ...
    // ── Constructor ──────────────────────────────────────────────────────────
    public HP34401AFrontPanelViewModel(HP34401ADriver driver)
    {
        _driver = driver;
    ...
    private async Task<double?> PerformMeasurementAsync()
    {
        ...
        try
        {
            ...
            double value = SelectedFunction switch
            {
                ...
                "DIODE"  => await _driver.MeasureDiode(range, nplc),
                "CONT"   => await _driver.MeasureContinuity(range, nplc),
